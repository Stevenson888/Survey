...
<!--      </el-popconfirm>-->
<!--      &lt;!&ndash; <el-upload action="http://local host:9090/chinaRegion/import" :show-file-list="false" accept="xlsx" :on-success="handleExcelImportSuccess" style="display: inline-block">-->
...
<!--      <el-table-column prop="areaCode" label="地区编码"></el-table-column>-->
<!--      <el-table-column prop="areaName" label="地区名"></el-table-column>-->
<!--      <el-table-column prop="level" label="地区级别"></el-table-column>-->
<!--      <el-table-column prop="cityCode" label="城市编码"></el-table-column>-->
<!--      <el-table-column prop="center" label="城市中心点（即：经纬度坐标）"></el-table-column>-->
<!--      <el-table-column prop="parentId" label="地区父节点"></el-table-column>-->
<!--      <el-table-column prop="isEnable" label="是否启用 1启用 0禁用"></el-table-column>-->
...
<!--        </el-form-item>-->
<!--        <el-form-item label="城市中心点（即：经纬度坐标）">-->
<!--          <el-input v-model="form.center" autocomplete="off"></el-input>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="地区父节点">-->
<!--          <el-input v-model="form.parentId" autocomplete="off"></el-input>-->
<!--        </el-form-item>-->
<!--        <el-form-item label="是否启用 1启用 0禁用">-->
...
<!--  methods: {-->
<!--    load() {-->
<!--      this.request.get("/chinaRegion/page", {-->
<!--        params: {-->
...
<!--    },-->
<!--    save() {-->
<!--      this.request.post("/chinaRegion", this.form).then(res => {-->
<!--        if (res.code === '200') {-->
...
<!--    },-->
<!--    del(id) {-->
<!--      this.request.delete("/chinaRegion/" + id).then(res => {-->
<!--        if (res.code === '200') {-->
...
<!--      this.request.post("/chinaRegion/del/batch", ids).then(res => {-->
<!--        if (res.code === '200') {-->
...
<!--    },-->
<!--    exp() {-->
<!--      window.open("http://local host:9090/chinaRegion/export")-->
<!--    },-->
